        ...
        <nav class="navbar navbar-expand-lg shadow text-light">
            <div class="container">
              ...
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <?php
                  foreach($menus as $m){
                    if($m['name'][2]=='Home Menu'){
                      echo "
                        <li class=\"size nav-item pe-3\">
                          <a class=\"text-bold  nav-link\" aria-current=\"page\" href=\"#\">{$m['name'][2]}</a>
                        </li>
                      ";
                    }
                    elseif($m['name'][2]=='Dropdown 1'){
                      echo "
                      ...
                      <a class=\"text-bold  nav-link dropdown-toggle\" href=\"#\" id=\"navbarDropdown\" role=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                        ...
                        <ul class=\"dropdown-menu\" aria-labelledby=\"navbarDropdown\"> ";
                          foreach($menus as $m){                        
                            echo "<li><a class=\"dropdown-item\" href=\"#\">{$m['name'][0]}</a></li>";
                          }
                        echo "  
                        </ul>
                      </li>
                    ...
                    elseif($m['name'][2]=='Dropdown 2'){
                      ...
                      <a class=\"text-bold  nav-link dropdown-toggle\" href=\"#\" id=\"navbarDropdown\" role=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                        ...
                        <ul class=\"dropdown-menu\" aria-labelledby=\"navbarDropdown\"> ";
                          foreach($menus as $m){                        
                            echo "<li><a class=\"dropdown-item\" href=\"#\">{$m['name'][1]}</a></li>";
                          }                        
                          echo " 
                        </ul>
                      </li>
                      ...
                      echo "<li class=\"nav-item px-2\">
                              <a class=\"nav-link text-bold\" href=\"#\"> {$m['name'][2]} </a>
                            </li>
                            ";
                    }
                  }
